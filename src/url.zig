...
pub const Slice = struct {
    pub fn protocol(parsed_url: *bun.jsc.URL, allocator: std.mem.Allocator) ![]const u8 {
        const str = parsed_url.protocol();
        defer str.deref();
    ...
    pub fn host(parsed_url: *bun.jsc.URL, allocator: std.mem.Allocator) ![]const u8 {
        const str = parsed_url.host();
        defer str.deref();
        const utf8 = str.toUTF8(allocator);
        defer utf8.deinit();
        return allocator.dupe(u8, utf8.slice());
    ...
    pub fn pathname(parsed_url: *bun.jsc.URL, allocator: std.mem.Allocator) ![]const u8 {
        const str = parsed_url.pathname();
        defer str.deref();
        const utf8 = str.toUTF8(allocator);
        defer utf8.deinit();
        return allocator.dupe(u8, utf8.slice());
    ...
    pub fn hash(parsed_url: *bun.jsc.URL, allocator: std.mem.Allocator) ![]const u8 {
        const str = parsed_url.hash();
        defer str.deref();
        const utf8 = str.toUTF8(allocator);
        defer utf8.deinit();
        return allocator.dupe(u8, utf8.slice());
    ...
    pub fn href(parsed_url: *bun.jsc.URL, allocator: std.mem.Allocator) ![]const u8 {
        const str = parsed_url.href();
        defer str.deref();
        const utf8 = str.toUTF8(allocator);
        defer utf8.deinit();
        return allocator.dupe(u8, utf8.slice());
